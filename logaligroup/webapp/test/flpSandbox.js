		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Logali Group",
									"targetURL": "#htlm5modulelogaligroup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"htlm5modulelogaligroup-display": {
								"semanticObject": "htlm5modulelogaligroup",
								"action": "display",
								"description": "Proyecto final - Master SAPUI5",
								"title": "Logali Group",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=htlm5module.logaligroup",
									"url": sap.ui.require.toUrl("htlm5module/logaligroup")
								}
							}
						}
					}
